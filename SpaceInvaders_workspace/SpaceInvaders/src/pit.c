...
=======
	XIo_Out32(XPAR_PIT_0_BASEADDR+PIT_DELAY_VAL, PIT_DELAY_INIT); //Set delay value
	XIo_Out32(XPAR_PIT_0_BASEADDR+PIT_CONTROL_REG, PIT_CONTROL_INIT); //Enable interrupts
...
=======
	XIo_Out32(XPAR_PIT_0_BASEADDR+PIT_DELAY_VAL, atoi(delay)); //Write new delay value
>>>>>>> 46133ae2d6a022a717e89ee90e8959352f12048c
