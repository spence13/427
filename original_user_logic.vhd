...
-- Date:              Mon Dec 05 13:32:23 2016 (by Create and Import Peripheral Wizard)
...
architecture IMP of user_logic is
  ...
  signal slv_reg1                       : std_logic_vector(C_SLV_DWIDTH-1 downto 0); --Use to set number of bits to transfer
  signal slv_reg2                       : std_logic_vector(C_SLV_DWIDTH-1 downto 0); --Source Address
  signal slv_reg3                       : std_logic_vector(C_SLV_DWIDTH-1 downto 0); --Destination Address
  ...
  signal Bus2IP_Reset                   : std_logic;
	...
	-- Signals for DMA control Lab 8
	signal read_write_flag								: std_logic := '0'; --0 for read, 1 for write
	signal bit_counter										: unsigned(31 downto 0) := (others => '0');
	signal address_incr										: unsigned(31 downto 0) := (others => '0');
      ...
      if ( Bus2IP_Resetn = '0' ) then
        ...
        case mst_cmd_sm_state is
          ...
          when CMD_WAIT_FOR_DATA =>
						slv_reg0 <= "00000000000000000000000000001000";
          ...
          when CMD_DONE =>
						slv_reg0 <= "00000000000000000000000000010000";
          ...
          when others =>
						slv_reg0 <= "00000000000000000000000000100000";
            mst_cmd_sm_state    <= CMD_IDLE;
            mst_cmd_sm_busy     <= '0';
